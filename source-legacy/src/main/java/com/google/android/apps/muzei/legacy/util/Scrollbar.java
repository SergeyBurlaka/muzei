...
package com.google.android.apps.muzei.legacy.util;
...
public class Scrollbar extends View {
    private static final int DEFAULT_BACKGROUND_COLOR = 0x33ffffff;
    private static final int DEFAULT_INDICATOR_COLOR = 0xffffffff;
